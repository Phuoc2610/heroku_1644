  ...
  for (let i = 0; i < num_rows; i++) {
    ...
    table_string += `<td >
                <button type="submit" name='crud' 
                    class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" value='update'>Update</button>
                <button type="submit" name='crud' 
                    class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded" value='delete'>Delete</button>
            </td>`;
